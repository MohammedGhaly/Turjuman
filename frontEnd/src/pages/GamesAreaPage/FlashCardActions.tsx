  ...
  return (
    <div className="w-full flex justify-center items-center">
      <div className="h-full lg:w-3/5 flex justify-center  items-stretch  bg-[var(--inner-boxes-bg)] gap-[0.4rem] md:gap-2 p-2 rounded-xl">
        <button
          className="text-sm md:text-base p-3 md:px-4 md:py-5 bg-red-200 text-red-900 dark:bg-opacity-50 dark:bg-red-700 dark:text-red-200 rounded-lg font-semibold flex-1 transition-all duration-200 hover:bg-opacity-30"
          key={"actionBtn1"}
        >
          very hard
        </button>
        <button
          className="text-sm md:text-base p-3 md:px-4 md:py-5 bg-orange-200 text-orange-900 dark:bg-opacity-40 dark:bg-orange-500 dark:text-orange-200  rounded-lg font-semibold flex-1  transition-all duration-200 hover:bg-opacity-30"
          key={"actionBtn2"}
        >
          hard
        </button>
        <button
          className="text-sm md:text-base p-3 md:px-4 md:py-5 bg-green-200 text-green-900 dark:bg-opacity-40 dark:bg-green-700 dark:text-green-200 rounded-lg font-semibold flex-1  transition-all duration-200 hover:bg-opacity-30"
          key={"actionBtn3"}
        >
          medium
        </button>
        <button
          className="text-sm md:text-base p-3 md:px-4 md:py-5 bg-blue-200 text-blue-900 dark:bg-opacity-40 dark:bg-blue-700 dark:text-blue-200  rounded-lg font-semibold flex-1  transition-all duration-200 hover:bg-opacity-30"
          key={"actionBtn4"}
        >
          easy
        </button>
